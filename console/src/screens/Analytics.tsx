...
import { resolutionMetrics } from '../lib/metrics.ts';
...
export default function Analytics() {
  ...
  // Real resolution KPIs from the status timeline (see lib/metrics).
  const { avgResLabel, resolvedThisWeek, resolvedDelta } = useMemo(() => resolutionMetrics(reports), [reports]);
